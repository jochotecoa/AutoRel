...
saveRDS(object = norm_counts, file = 'data/apap_hecatos/norm_counts_deseq2_apap_hecatos_3vs3.rds')


res <- results(dds, contrast = c("conditions","APA_The","ConDMSO"))

saveRDS(object = res, file = 'data/apap_hecatos/results_dds_deseq2_apap_hecatos_3vs3.rds')
