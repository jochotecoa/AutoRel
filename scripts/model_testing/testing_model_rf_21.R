...
table(model_rf$coefnames %in% colnames(test_data_9))

test_data_9_ori = test_data_9

test_data_9 = 
  test_data_9[, colnames(test_data_9) %in% model_rf$coefnames]
...
obsVSpred <- data.frame(actual = test_data_9$significance,
                    predict(model_rf, newdata = test_data_9))
...
cm_test_data_9 %>% saveRDS(paste0(conf_matr_path, '/rf/test_data_9.rds'))
...
table(model_rf$coefnames %in% colnames(test_data_3))

test_data_3_ori = test_data_3

test_data_3 = 
  test_data_3[, colnames(test_data_3) %in% model_rf$coefnames]
...
obsVSpred <- data.frame(actual = test_data_3$significance,
                        predict(model_rf, newdata = test_data_3))
obsVSpred$predict = obsVSpred[, 2] %>% as.factor()
...
cm_test_data_3 %>% saveRDS(paste0(conf_matr_path, '/rf/test_data_3.rds'))
...
table(model_rf$coefnames %in% colnames(test_data_3_9_21))

test_data_3_9_21_ori = test_data_3_9_21

test_data_3_9_21 = 
  test_data_3_9_21[, colnames(test_data_3_9_21) %in% model_rf$coefnames]
...
obsVSpred <- data.frame(actual = test_data_3_9_21$significance,
                        predict(model_rf, newdata = test_data_3_9_21))
obsVSpred$predict = obsVSpred[, 2] %>% as.factor()
...
cm_test_data_3_9_21 %>% saveRDS(paste0(conf_matr_path, '/rf/test_data_3_9_21.rds'))
