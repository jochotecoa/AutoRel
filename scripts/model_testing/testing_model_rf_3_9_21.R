...
table(model_rf$coefnames %in% colnames(test_data_21))

test_data_21_ori = test_data_21

test_data_21 = 
  test_data_21[, colnames(test_data_21) %in% model_rf$coefnames]
...
obsVSpred <- data.frame(actual = test_data_21$significance,
                    predict(model_rf, newdata = test_data_21))
...
cm_test_data_21 %>% saveRDS(paste0(conf_matr_path, '/rf/test_data_21.rds'))
