...
for (i in seq_len(n_replicates)) {
  ...
  source('scripts/simulated_dataset/generate_spsimseq_21R.R')
  ...
  if (!dir.exists('data/simulated_data/21R')) {
    dir.create('data/simulated_data/21R', recursive = T)
  }
  norm_counts_path = 'data/simulated_data/21R/norm_counts.rds'
  norm_counts_features_path = 'data/simulated_data/21R/norm_counts_features.rds'
  ...
  res_dds_path = 'data/simulated_data/21R/results_dds_deseq2.rds'
  all_res_path = 'data/simulated_data/21R/all_res.rds'
  saveRDS(object = res, file = res_dds_path)
  
  source('scripts/pre-processing/deriving_features_from_res.R')
  
  deseq2_dataset_all_path = 'data/simulated_data/21R/deseq2_features_all.rds'
