...
if (!dir.exists('output/simulated_data/50R/')) {
  dir.create('output/simulated_data/50R/', recursive = T)
}

saveRDS(conf_matr_all_df, 'output/simulated_data/50R/relevant_performance.rds')
