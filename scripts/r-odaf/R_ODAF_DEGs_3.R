...
SampleDataFile <- "sampleData_3.csv" #This comma delimited file contains the merged RSEM.genes.results files
SampleKeyFile <- "samplekeyTEST_3.csv" #This comma delimited file contains at least 2 columns: NAME (sample names identical to the column names of sampleData) and Compound (needs to identify to which group the sample belongs -> ExperimentalGroup & ControlGroup)
