...
if (!dir.exists('output/trained_models/apap_21vs21/ordinalNet/')) {
  dir.create('output/trained_models/apap_21vs21/ordinalNet/', recursive = T)
}

model_ordinalNet %>% saveRDS('output/trained_models/apap_21vs21/ordinalNet/original.rds')
...
if (!dir.exists('output/confusion_matrices/apap_21vs21/ordinalNet/')) {
  dir.create('output/confusion_matrices/apap_21vs21/ordinalNet/', recursive = T)
}

# cm_over %>% saveRDS('output/confusion_matrices/apap_21vs21/ordinalNet/over-sampling.rds')
cm_original %>% saveRDS('output/confusion_matrices/apap_21vs21/ordinalNet/original.rds')
# cm_under %>% saveRDS('output/confusion_matrices/apap_21vs21/ordinalNet/under-sampling.rds')
