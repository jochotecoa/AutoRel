...
if (!dir.exists('output/confusion_matrices/apap_9vs9/rpart2/')) {
  dir.create('output/confusion_matrices/apap_9vs9/rpart2/', recursive = T)
}

# cm_over %>% saveRDS('output/confusion_matrices/apap_9vs9/rpart2/over-sampling_expressed.rds')
cm_original %>% saveRDS('output/confusion_matrices/apap_9vs9/rpart2/original_expressed.rds')
# cm_under %>% saveRDS('output/confusion_matrices/apap_9vs9/rpart2/under_sampling_expressed.rds')
...
# cm_over %>% saveRDS('output/confusion_matrices/apap_9vs9/rpart2/over-sampling_expressed.rds')
cm_under_sampling %>% saveRDS('output/confusion_matrices/apap_9vs9/rpart2/under_sampling_expressed.rds')
# cm_under %>% saveRDS('output/confusion_matrices/apap_9vs9/rpart2/under_sampling_expressed.rds')
...
# cm_over %>% saveRDS('output/confusion_matrices/apap_9vs9/rpart2/over-sampling_expressed.rds')
cm_over_sampling %>% saveRDS('output/confusion_matrices/apap_9vs9/rpart2/over_sampling_expressed.rds')
# cm_over %>% saveRDS('output/confusion_matrices/apap_9vs9/rpart2/over_sampling_expressed.rds')
