...
# cm_under %>% saveRDS('output/confusion_matrices/apap_21vs21/rpart2/under_sampling.rds')
...
model_rpart2_under %>% saveRDS('output/trained_models/apap_21vs21/rpart2/under_sampling.rds')
...
# cm_over %>% saveRDS('output/confusion_matrices/apap_21vs21/rpart2/over-sampling.rds')
cm_under_sampling %>% saveRDS('output/confusion_matrices/apap_21vs21/rpart2/under_sampling.rds')
# cm_under %>% saveRDS('output/confusion_matrices/apap_21vs21/rpart2/under_sampling.rds')
...
model_rpart2_over %>% saveRDS('output/trained_models/apap_21vs21/rpart2/over_sampling.rds')
...
# cm_over %>% saveRDS('output/confusion_matrices/apap_21vs21/rpart2/over-sampling.rds')
cm_over_sampling %>% saveRDS('output/confusion_matrices/apap_21vs21/rpart2/over_sampling.rds')
# cm_over %>% saveRDS('output/confusion_matrices/apap_21vs21/rpart2/over_sampling.rds')
