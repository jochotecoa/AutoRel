...
if (!dir.exists('output/trained_models/apap_21vs21/xgbDART/')) {
  dir.create('output/trained_models/apap_21vs21/xgbDART/', recursive = T)
}

model_xgbDART %>% saveRDS('output/trained_models/apap_21vs21/xgbDART/original.rds')
...
if (!dir.exists('output/confusion_matrices/apap_21vs21/xgbDART/')) {
  dir.create('output/confusion_matrices/apap_21vs21/xgbDART/', recursive = T)
}

# cm_over %>% saveRDS('output/confusion_matrices/apap_21vs21/xgbDART/over-sampling.rds')
cm_original %>% saveRDS('output/confusion_matrices/apap_21vs21/xgbDART/original.rds')
# cm_under %>% saveRDS('output/confusion_matrices/apap_21vs21/xgbDART/under-sampling.rds')
