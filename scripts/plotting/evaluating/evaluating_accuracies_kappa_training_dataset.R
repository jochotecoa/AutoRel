for (path_model_i in list.files('/ngs-data-2/analysis/juan/autosign/trained_models/apap_21vs21/', 
                                full.names = T, recursive = T, pattern = '.rds')) {
  model_i_name = path_model_i %>% 
    gsub('/ngs-data-2/analysis/juan/autosign/trained_models/apap_21vs21//', '', .) %>% 
