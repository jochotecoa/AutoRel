...
norm_counts_features = readRDS('data/apap_hecatos/norm_counts_features_9vs9.rds') %>% 
  rownames_to_column('ensembl_gene_id')
all_res = readRDS(file = 'data/apap_hecatos/all_res_9vs9_apap_hecatos.rds') %>% 
  rownames_to_column('ensembl_gene_id')
...
saveRDS(object = deseq2_dataset_all, 
        file = 'data/apap_hecatos/deseq2_features_all_9vs9.rds')
