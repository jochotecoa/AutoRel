...
deseq2_dataset = readRDS(file = 'data/apap_hecatos/deseq2_dataset_9vs9.rds')
...
nonsign_rows_under = sample(nonsign_rows, size = length(sign_rows))
sign_rows_under = sign_rows
  # sample(sign_rows, size = length(dub_rows))

X_under = X[c(nonsign_rows_under, sign_rows_under), , F]
...
saveRDS(object = X, file = 'data/apap_hecatos/whole_data_preds_9vs9.rds')
saveRDS(object = X_c_s, file = 'data/apap_hecatos/whole_data_centered_scaled_preds_9vs9.rds')
saveRDS(object = X_notproc_cnt_scl, file = 'data/apap_hecatos/whole_data_unpreprocessed_centered_scaled_preds_9vs9.rds')
saveRDS(object = Y, file = 'data/apap_hecatos/whole_data_target_9vs9.rds')
saveRDS(object = deseq2_dataset_2, 'data/apap_hecatos/whole_dataset_labelled_9vs9.rds')
